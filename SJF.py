class SJF:
    ...
    def processData(self, no_of_processes):
            ...
            if(z==0):
                print("This is preemptive scheduling.")    
                SJF.schedulingProcess0(self, process_data)
            else:
                print("This is non preemptive scheduling.")
                SJF.schedulingProcess1(self, process_data)

    def schedulingProcess0(self, process_data):
    ...
    def schedulingProcess1(self, process_data):
        start_time = []
        exit_time = []
        s_time = 0
        process_data.sort(key=lambda x: x[1])
    ...
    def printData(self, process_data, average_turnaround_time, average_waiting_time, sequence_of_process):
        ...
        '''
        print("Process ID   Arrival Time     Rem Burst Time     Completed    Orig Burst Time     Completion Time     Turnaround Time     Waiting Time")
...
if __name__ == "__main__":
    print("THIS IS SHORTEST JOB FIRST PROGRAM")
    print("Do you want to solve it in preemptive or non-premptive manner. For preemptive type '0' and for non preemptive type '1'.")
    z=int(input("Enter your input here: "))
